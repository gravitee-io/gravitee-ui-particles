...
@Component({
  ...
  templateUrl: './gio-el-condition-type-number.component.html',
  styleUrl: './gio-el-condition-type-number.component.scss',
})
export class GioElConditionTypeNumberComponent implements OnChanges {
  @Input({
    required: true,
  })
