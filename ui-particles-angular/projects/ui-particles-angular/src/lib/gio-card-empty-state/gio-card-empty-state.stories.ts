...
import { GioCardEmptyStateComponent, GioCardEmptyStateModule } from '@gravitee/ui-particles-angular';
import { MatCardModule } from '@angular/material/card';

export default {
  title: 'Components / Card empty state',
  component: GioCardEmptyStateComponent,
  decorators: [
    moduleMetadata({
      imports: [GioCardEmptyStateModule, MatCardModule],
    }),
  ],
} as Meta;
...
export const SmallCardEmptyState: StoryObj = {
  render: () => ({
    template: `
