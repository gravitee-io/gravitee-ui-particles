...
export default {
  title: 'Policy Studio / APIM - Policy Studio / A2A Proxy API',
  decorators: [
    moduleMetadata({
...
export const A2aProxy: StoryObj = {
  name: 'A2A API',
  args: {
    apiType: 'A2A_PROXY' satisfies ApiType,
    entrypointsInfo: [fakeA2aProxyEntrypoint()],
    endpointsInfo: [fakeA2aProxyEndpoint()],
    commonFlows: [
      fakeA2aFlow(base => {
        return {
          ...base,
