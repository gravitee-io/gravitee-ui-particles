...
{/* <Story id="components-save-bar--simple-usage-in-creation-mode" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

<Story id="components-save-bar--simple-usage-in-creation-mode" />

Update mode:

{/* <Story id="components-save-bar--simple-usage-in-update-mode" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

<Story id="components-save-bar--simple-usage-in-update-mode" />
...
🚨 *Note: The save bar will not be automatically closed when the form is submitted. To close the save bar, you need to manually mark the form as untouched with `markAsUntouched()` method.*
