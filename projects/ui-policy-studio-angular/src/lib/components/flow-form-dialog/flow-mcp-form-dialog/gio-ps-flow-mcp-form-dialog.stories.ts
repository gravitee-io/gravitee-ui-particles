...
@Component({
  selector: 'gio-ps-flow-mcp-form-dialog-story',
...
class GioPolicyStudioFlowMcpFormDialogStoryComponent {
...
export default {
  title: 'Policy Studio / components / Flow mcp form dialog',
  component: GioPolicyStudioFlowMcpFormDialogStoryComponent,
  decorators: [
    moduleMetadata({
      declarations: [GioPolicyStudioFlowMcpFormDialogStoryComponent],
      imports: [GioPolicyStudioFlowMcpFormDialogComponent, MatDialogModule],
    }),
  ],
  argTypes: {},
  render: args => ({
