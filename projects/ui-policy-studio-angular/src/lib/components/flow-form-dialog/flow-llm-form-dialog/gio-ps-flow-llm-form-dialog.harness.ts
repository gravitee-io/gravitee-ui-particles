...
export class GioPolicyStudioFlowLlmFormDialogHarness extends ComponentHarness {
  public static hostSelector = 'gio-ps-flow-llm-form-dialog';
  ...
  private methodsInput = this.locatorFor(GioFormTagsInputHarness.with({ selector: '[formControlName="llmMethods"]' }));
  ...
  public async getFlowFormValues(): Promise<GioPolicyStudioFlowLlmHarnessData> {
    return {
