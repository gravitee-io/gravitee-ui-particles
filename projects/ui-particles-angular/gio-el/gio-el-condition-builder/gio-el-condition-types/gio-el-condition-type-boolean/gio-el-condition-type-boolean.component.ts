...
@Component({
  selector: 'gio-el-condition-type-boolean',
  imports: [CommonModule, MatFormFieldModule, MatSelectModule, ReactiveFormsModule, MatSlideToggle],
  templateUrl: './gio-el-condition-type-boolean.component.html',
  styleUrl: './gio-el-condition-type-boolean.component.scss',
})
export class GioElConditionTypeBooleanComponent implements OnChanges {
  @Input({
    required: true,
  })
