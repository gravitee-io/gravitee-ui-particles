...
@Component({
  selector: 'gio-ps-flow-llm-form-dialog-story',
...
class GioPolicyStudioFlowLlmFormDialogStoryComponent {
...
export default {
  title: 'Policy Studio / components / Flow llm form dialog',
  component: GioPolicyStudioFlowLlmFormDialogStoryComponent,
  decorators: [
    moduleMetadata({
      declarations: [GioPolicyStudioFlowLlmFormDialogStoryComponent],
      imports: [GioPolicyStudioFlowLlmFormDialogComponent, MatDialogModule],
    }),
  ],
  argTypes: {},
  render: args => ({
