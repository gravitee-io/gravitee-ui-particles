...
export type PhaseType = 'INTERACT' | 'REQUEST' | 'RESPONSE' | 'PUBLISH' | 'SUBSCRIBE' | 'CLIENT_CONNECT' | 'ENDPOINT_CONNECT';
...
const TYPE_TO_TEXT: Record<PhaseType, string> = {
  ...
  CLIENT_CONNECT: 'Client Connect phase',
  ENDPOINT_CONNECT: 'Endpoint Connect phase',
};
