...
export class GioElConditionBuilderDialogHarness extends ComponentHarness {
  public static readonly hostSelector = `gio-el-condition-builder-dialog`;

  public static with(options: GioElConditionBuilderDialogHarnessOptions): HarnessPredicate<GioElConditionBuilderDialogHarness> {
