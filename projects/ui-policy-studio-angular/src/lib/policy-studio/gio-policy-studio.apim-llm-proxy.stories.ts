...
export default {
  title: 'Policy Studio / APIM - Policy Studio / LLM Proxy API',
  decorators: [
    moduleMetadata({
...
export const LlmProxyKafka: StoryObj = {
  name: 'LLM API',
  args: {
    apiType: 'LLM_PROXY' satisfies ApiType,
    entrypointsInfo: [fakeLlmProxyEntrypoint()],
    endpointsInfo: [fakeLlmProxyEndpoint()],
    commonFlows: [
      fakeLlmFlow(base => {
        return {
          ...base,
