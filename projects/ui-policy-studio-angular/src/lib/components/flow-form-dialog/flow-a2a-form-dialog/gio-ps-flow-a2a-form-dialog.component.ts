...
export type GioPolicyStudioFlowA2aFormDialogData = {
  flow?: FlowVM;
};
...
@Component({
  ...
  selector: 'gio-ps-flow-a2a-form-dialog',
  templateUrl: './gio-ps-flow-a2a-form-dialog.component.html',
  styleUrls: ['./gio-ps-flow-a2a-form-dialog.component.scss'],
})
export class GioPolicyStudioFlowA2aFormDialogComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<GioPolicyStudioFlowA2aFormDialogComponent, GioPolicyStudioFlowFormDialogResult>,
    @Inject(MAT_DIALOG_DATA) flowDialogData: GioPolicyStudioFlowA2aFormDialogData,
  ) {
