...
import { fakeA2aFlow } from '../../../models/flow/Flow.fixture';

import { GioPolicyStudioFlowA2aFormDialogComponent, GioPolicyStudioFlowA2aFormDialogData } from './gio-ps-flow-a2a-form-dialog.component';

@Component({
  selector: 'gio-ps-flow-a2a-form-dialog-story',
...
class GioPolicyStudioFlowA2aFormDialogStoryComponent {
...
export default {
  title: 'Policy Studio / components / Flow a2a form dialog',
  component: GioPolicyStudioFlowA2aFormDialogStoryComponent,
  decorators: [
    moduleMetadata({
      declarations: [GioPolicyStudioFlowA2aFormDialogStoryComponent],
      imports: [GioPolicyStudioFlowA2aFormDialogComponent, MatDialogModule],
    }),
  ],
  argTypes: {},
  render: args => ({
